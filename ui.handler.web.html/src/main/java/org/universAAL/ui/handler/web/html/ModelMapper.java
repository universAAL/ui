...
import org.universAAL.ui.handler.web.html.model.FormModel;
import org.universAAL.ui.handler.web.html.model.LabelModel;
import org.universAAL.ui.handler.web.html.model.Model;
...
public final class ModelMapper {
	...
	private Object getModelFor(Object refObj, Class refObjClass) {
		...
		if (model == null) {
			...
			if (parentC != FormElement.class && parentC != Object.class) {
				...
				LogUtils.logError(render.getModuleContext(), getClass(), "getModelFor", new String[] {
						"This is really awkward, ", "No Model found... ", "or as any antecesor... ", "COME ON!!" },
						null);
			}
		}
		return model;
