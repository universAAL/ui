...
import org.universAAL.ui.handler.web.html.model.GroupModel;
import org.universAAL.ui.handler.web.html.model.InputFieldModel;
import org.universAAL.ui.handler.web.html.model.LabelModel;
import org.universAAL.ui.handler.web.html.model.MediaObjectModel;
import org.universAAL.ui.handler.web.html.model.RangeModel;
import org.universAAL.ui.handler.web.html.model.RepeatModel;
import org.universAAL.ui.handler.web.html.model.Select1Model;
import org.universAAL.ui.handler.web.html.model.SelectModel;
import org.universAAL.ui.handler.web.html.model.SimpleOutputModel;
import org.universAAL.ui.handler.web.html.model.SubmitModel;
import org.universAAL.ui.handler.web.html.model.TextAreaModel;
...
public class DefaultModelConstructorTest extends TestCase {
	...
	public void testMediaObject() {
		pw.println(
				new MediaObjectModel(new MediaObject(f.getIOControls(), l, "image/png", "app/Health2.png"), testRender)
						.generateHTML());
	}
	 ...
	 * Form.newSubdialog("subdialog", f.getDialogID()); new FormModel(f); new
	 * FormModel(subD); SubdialogTrigger st = new
	 * SubdialogTrigger(f.getSubmits(), l, subD.getDialogID()); new
	 * SubdialogTriggerModel(st).getHTML();; }
	 */
