 ...
 * ContextEvents thus acts as an adapter. Implementing classes create and handle
 * specific ContextEvent with specific arguments.
 * 
 * 
 */
public interface AbstractContext {
	 ...
	 * 
	 * @param response
	 *            The ContextEvent to be processed
