 ...
 ******************************************************************************/
package org.universAAL.plainJava;
...
public class POJOContainer implements Container {
	...
	private static POJOContainer instance = null;
...
//	private Map<String, POJOModuleContext> modules;
	...
	private POJOContainer(){
		listeners = new ArrayList<SharedObjectListener>();	
		sharedObjectMap = new HashMap<String, Object>();
	};
	
	public static POJOContainer getInstance(){
		if (instance == null) {
			instance = new POJOContainer();
		}
		return instance;
	}
	...
	public ModuleContext registerModule(Object[] regParams) {
		POJOModuleContext mc = new POJOModuleContext((ModuleActivator)regParams[0]); 
		return mc;
	}
