...
public class MainMenu {
    ...
    /**
     * Get an instance of the main menu given a user. Creates the menu if it was
	...
	// 3. service class
	try {
	    InputStream in = SharedResources.getConfFileAsStream("main_menu_"
		    + thisUser + lang + ".txt");
	    // if (in == null)
	...
	if (selection == null || selection == root)
	    ...
	    if (parent == null)
		parent = root;
	    new Submit(g, new Label(selection.getLabel(), null), parent
		    .getPath());
