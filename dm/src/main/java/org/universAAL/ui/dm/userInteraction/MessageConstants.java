...
public interface MessageConstants {
	 ...
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_DATE = "PendingDialogBuilder.date";
	/**
	 * 
	 */
	 ...
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_OK = "PendingDialogBuilder.ok";
	/**
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_SUBJECT = "PendingDialogBuilder.subject";
	/**
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_SWITCH_TO = "PendingDialogBuilder.switchTo";
	/**
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_SWITCH_TO_HELP = "PendingDialogBuilder.switchTo.help";
	/**
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_WITH_SUBMITS_NO_PENDING_DIALOGS = "PendingDialogBuilderWithSubmits.noPendingDialogs";
	/**
	 * 
	 */
	static final String PENDING_DIALOG_BUILDER_WITH_SUBMITS_OK = "PendingDialogBuilderWithSubmits.ok";
	/**
	 * 
	 */
