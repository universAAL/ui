...
public class DateTime {
	...
	String date = "<html><table><tr><td align=center valign=middle> <font face=Myriad Pro size=7 color=#565656>"
		+ values[0]
		+ "</font>"
		...
		+ ""
		+ values[2]
		+ "</font></td><tr><td><font face=Myriad Pro size=4 color=#00a77f>Sound</font></td><td><font face=Myriad Pro size=4 color=#565656>Off</font></td></tr></table>";
