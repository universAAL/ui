...
public class POJOModuleContext implements ModuleContext {
	...
	private static Appender fa;
	static {
		try {
			fa = new FileAppender(new PatternLayout(), "target/JUnit.log", false);
		} catch (IOException e) {
	 ...
	 * 
	 */
	public POJOModuleContext(ModuleActivator ma) {
		activator = ma;
