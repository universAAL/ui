...
public class BluesteelLAFConstructorTest extends TestCase {
	...
	InputField i = new InputField(f.getIOControls(), l, getPath("InputF1"),
		null, null);
	new InputFieldLAF(i, testRender).getComponent();
    }

    public void testInputField2() {
	InputField i = new InputField(f.getIOControls(), l, getPath("InputF2"),
		null, new String(""));
	new InputFieldLAF(i, testRender).getComponent();
    }

    public void testInputField3() {
	InputField i = new InputField(f.getIOControls(), l, getPath("InputF3"),
		null, new String("lala"));
	i.setSecret();
	new InputFieldLAF(i, testRender).getComponent();
    }

    public void testInputField4() {
	InputField i = new InputField(f.getIOControls(), l, getPath("InputF4"),
		null, new Locale("en"));
	new InputFieldLAF(i, testRender).getComponent();
    }
	...
	new MediaObjectLAF(new MediaObject(f.getIOControls(), l, "image/png",
		"services/Health_Button.png"), testRender);
    }

    public void testRange1() {
	Range r = new Range(f.getIOControls(), l, getPath("Range1"),
		MergedRestriction.getAllValuesRestriction(getPath("Range1")
			.getThePath()[0], new IntRestriction(
			Integer.valueOf(3), true, Integer.valueOf(12), true)),
		Integer.valueOf(5));
	...
	Range r = new Range(f.getIOControls(), l, getPath("Range2"),
		MergedRestriction.getAllValuesRestriction(getPath("Range2")
			.getThePath()[0], new IntRestriction(
			Integer.valueOf(1), true, Integer.valueOf(100), true)),
		Integer.valueOf(50));
	new RangeLAF(r, testRender).getComponent();
    }
	...
	Select1 s1 = new Select1(f.getIOControls(), l, getPath("Select1"),
		null, "Opt2");
	...
	Select s = new Select(f.getIOControls(), l, getPath("Select"), null,
		Integer.valueOf(10));
	s.generateChoices(new Integer[] { Integer.valueOf(0),
		Integer.valueOf(2), Integer.valueOf(4), Integer.valueOf(6),
		Integer.valueOf(8), Integer.valueOf(10), Integer.valueOf(12) });
	...
	SimpleOutput so = new SimpleOutput(f.getIOControls(), l, null, Integer
		.valueOf(5));
	new SimpleOutputLAF(so, testRender).getComponent();
    }
	...
	TextArea ta = new TextArea(f.getIOControls(), l, getPath("TextArea1"),
		null, null);
