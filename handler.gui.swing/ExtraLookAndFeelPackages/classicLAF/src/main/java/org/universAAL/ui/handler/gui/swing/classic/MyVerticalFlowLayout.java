...
/*
 * @(#)MyVerticalFlowLayout.java	1.52 03/12/19
 *
 ...
 * <p>
 * <img src="doc-files/MyVerticalFlowLayout-1.gif"
 ...
 */
public class MyVerticalFlowLayout implements LayoutManager, java.io.Serializable {
    ...
    /**
     * Constructs a new <code>MyVerticalFlowLayout</code> with a centered alignment and a
    ...
    /**
     * Constructs a new <code>MyVerticalFlowLayout</code> with the specified
     * alignment and a default 5-unit horizontal and vertical gap.
     * The value of the alignment argument must be one of
     * <code>MyVerticalFlowLayout.TOP</code>, <code>MyVerticalFlowLayout.BOTTOM</code>,
     * <code>MyVerticalFlowLayout.CENTER</code>, <code>MyVerticalFlowLayout.LEADING</code>,
     * or <code>MyVerticalFlowLayout.TRAILING</code>.
     * @param align the alignment value
     */
    public MyVerticalFlowLayout(int align) {
	this(align, 5, 5);
    }
     ...
     * Possible values are <code>MyVerticalFlowLayout.TOP</code>,
     * <code>MyVerticalFlowLayout.BOTTOM</code>, <code>MyVerticalFlowLayout.CENTER</code>,
     * <code>MyVerticalFlowLayout.LEADING</code>,
     * or <code>MyVerticalFlowLayout.TRAILING</code>.
	...
	for (int i = colStart ; i < colEnd ; i++) {
	    Component m = target.getComponent(i);
	    int xx=x;
	    switch (FormLAF.vGroupHalign) {
		case FormLAF.H_CENTER:
		    xx=x + (width - m.getWidth()) / 2;
		    break;
		case FormLAF.H_RIGHT:
		    xx=x + (width -  m.getWidth());
		    break;
		}
	    if (m.isVisible()) {
	        if (ltr) {
        	    m.setLocation(xx /*+ (width - m.getWidth()) / 2*/, y);
	        } else {
	            m.setLocation(xx /*+ (width - m.getWidth()) / 2*/, target.getHeight() - y - m.getHeight());
                }
                y += m.getHeight() + vgap;
	    }
	}
     ...
     * this <code>MyVerticalFlowLayout</code> object.
     *
...
//		    colw=moveComponents(target, insets.left + hgap, y, maxheight - x, colw, start, i, ltr);
