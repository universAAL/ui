...
public class UIPreferencesSubprofileHelper {
	...
	private static final String OUTPUT_GETSUBPROFILES = UIPreferencesProvidedService.NAMESPACE + "outputSubprofile";
	...
	public String changeSubProfile(SubProfile subProfile) {
		...
		LogUtils.logDebug(mcontext, this.getClass(), "changeSubProfile", new Object[] { "ui subprofile: "
		...
		if (resp.getCallStatus() == CallStatus.succeeded) {
			try {
				...
				if (subProfiles == null || subProfiles.size() == 0) {
					LogUtils.logInfo(mcontext, this.getClass(), "getUIPreferencesSubProfilesForUser",
			...
			LogUtils.logWarn(mcontext, this.getClass(), "getUIPreferencesSubProfileForUser",
	...
	public boolean addSubprofileToUserProfile(UserProfile userProfile, SubProfile subProfile) {
		...
		if (resp.getCallStatus() == CallStatus.succeeded) {
			...
			LogUtils.logDebug(mcontext, this.getClass(), "addSubprofileToUserProfile",
