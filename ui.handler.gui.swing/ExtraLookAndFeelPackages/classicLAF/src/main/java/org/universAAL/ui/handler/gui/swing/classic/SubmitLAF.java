...
public class SubmitLAF extends SubmitModel implements ComponentListener {
	...
	public void componentResized(ComponentEvent e) {
		if (fc.getLabel() != null && ((AbstractButton) e.getComponent()).getIcon() == null) {
			...
			// }else{
			// ((AbstractButton)
			// e.getComponent()).setIcon(ColorLAF.button_normal);
			// ((AbstractButton)
			// e.getComponent()).setPressedIcon(ColorLAF.button_pressed);
			// ((AbstractButton)
			// e.getComponent()).setRolloverIcon(ColorLAF.button_focused);
