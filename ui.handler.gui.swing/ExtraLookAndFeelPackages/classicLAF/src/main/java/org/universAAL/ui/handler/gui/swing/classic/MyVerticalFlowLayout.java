 ...
 * <p>
 * <img src="doc-files/MyVerticalFlowLayout-1.gif" ALT="Graphic of Layout for
...
public class MyVerticalFlowLayout implements LayoutManager, java.io.Serializable {
	...
	/**
	 * Constructs a new <code>MyVerticalFlowLayout</code> with a centered
			...
			for (int i = 0; i < nmembers; i++) {
				...
				if (m.isVisible()) {
					...
					if ((y == 0) || ((y + d.height) <= maxheight)) {
						...
						// colw=moveComponents(target, insets.left + hgap, y,
						// maxheight - x, colw, start, i, ltr);
