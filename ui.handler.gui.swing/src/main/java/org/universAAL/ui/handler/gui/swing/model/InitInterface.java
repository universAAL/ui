...
public interface InitInterface {
	...
	/**
	 * The procedure of uninstalling the LAF. Any actions needed to stop using
	...
	/**
	 * Show the Login dialog. this method then must call
	 * {@link Renderer#authenticate(String, String)} to complete the login
	 * process. NOTE: no need to self call
	 * {@link InitInterface#userLogIn(User)}, that is handled by
	 * {@link Renderer#authenticate(String, String)} NOTE2: if
	 * {@link Renderer#authenticate(String, String)} fails no recall this method
	 * is done, this method should manage failed attempts.
	 */
